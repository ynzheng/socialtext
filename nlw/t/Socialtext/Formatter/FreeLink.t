...
<br /><p>
<a href="index.cgi?action=display;is_incipient=1;page_name=x" wiki_page=""  title="[click to create page]" class="incipient">x</a><br />
<a href="index.cgi?action=display;is_incipient=1;page_name=%C3%A1" wiki_page=""  title="[click to create page]" class="incipient">$a_acute_u</a></p>
</div>

...
--- match
<h3 id="hello_there_wilbur">Hello <a href="index.cgi\?[^"]+page_name=There" wiki_page=""  title="\[click to create page\]" class="incipient">There</a> Wilbur</h3>
...
--- match
<h2 id="hello_there_wilbur"><a href="index.cgi\?[^"]+page_name=Hello%20There%20Wilbur" wiki_page=""  title="\[click to create page\]" class="incipient">Hello There Wilbur</a></h2>
